...
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (3323,4,' Descrição de qualquer informação relevante','Administracão pública','Hospital Springfield','Municipal',3.25);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (55555,3,' Descrição sobre o hospital e como ele funciona','Administracão pública','Hospital Wakanda ','Estadual',3.33);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (8888,4,' Horario de funcionamento de 8h até 17h','Filantropico','HCB Trata Coracao','Municipal',3.5);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (59911,1,' funciona 24 horas','Administracão pública','UPA do alto do morro ','Federal',2.0);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (54445,2,' Descriçao sobre este hospital','Administracão pública','Hospital de Fratura','Federal',3.0);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (44443,NULL,' Descriçao sobre este hospital6','Administracão pública','HGR hospital Geral dos Restaurados','Federal',NULL);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (60020,2,' Descriçao sobre este hospital7','Administracão pública','UPA baixa rio lago','Federal',2.5);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (7777,NULL,' Descriçao sobre este hospital8','Administracão pública','UPA Morro baixo','Federal',NULL);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (66666,NULL,' Descriçao sobre este hospital9','Filantropico','HO hospital da Vida','Municipal',NULL);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (3333,1,' Descriçao sobre este hospital10','Administracão pública','HCP ','Federal',1.0);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (35445,NULL,' Descriçao sobre este hospital11','Administracão pública','HB2','Federal',NULL);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (76444,NULL,' Descriçao sobre este hospital12','Administracão pública','Hospital de Camaragib','Federal',NULL);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES (600,4,' Descriçao sobre este hospital13','Administracão pública','UPA pdsw','Federal',3.5);
INSERT INTO estabelecimento (cod_cnes,count,descricao,natureza_juridica,nome,orgao_gestor,score) VALUES  (27554,NULL,' Descriçao sobre este hospital14','Administracão pública','Pronto Socorro Villa Grande ','Federal',NULL);	
