...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Estabelecimento estab1 = new Estabelecimento(null, "Hospital Springfield", 3323, " Descrição de qualquer informação relevante", "Municipal", "Administracão pública", 3.25,4);
		Estabelecimento estab2 = new Estabelecimento(null, "Hospital Wakanda ", 55555, " Descrição sobre o hospital e como ele funciona", "Estadual", "Administracão pública",3.33,3);		
		Estabelecimento estab3 = new Estabelecimento(null, "HCB Trata Coracao", 8888, " Horario de funcionamento de 8h até 17h", "Municipal", "Filantropico",3.5,4);
		Estabelecimento estab4 = new Estabelecimento(null, "UPA do alto do morro ", 59911, " funciona 24 horas", "Federal", "Administracão pública",2.0,1);
		Estabelecimento estab5 = new Estabelecimento(null, "Hospital de Fratura", 54445, " Descriçao sobre este hospital", "Federal", "Administracão pública",3.0,2);
		Estabelecimento estab6 = new Estabelecimento(null, "HGR hospital Geral dos Restaurados", 44443, " Descriçao sobre este hospital6", "Federal", "Administracão pública",null,null);
		Estabelecimento estab7 = new Estabelecimento(null, "UPA baixa rio lago", 60020, " Descriçao sobre este hospital7", "Federal", "Administracão pública",2.5,2);
		Estabelecimento estab8 = new Estabelecimento(null, "UPA Morro baixo", 7777, " Descriçao sobre este hospital8", "Federal", "Administracão pública",null,null);
		Estabelecimento estab9 = new Estabelecimento(null, "HO hospital da Vida", 66666, " Descriçao sobre este hospital9", "Municipal", "Filantropico",null,null);
		Estabelecimento estab10 = new Estabelecimento(null, "HCP ", 3333, " Descriçao sobre este hospital10", "Federal", "Administracão pública",1.0,1);
		Estabelecimento estab11 = new Estabelecimento(null, "HB2", 35445, " Descriçao sobre este hospital11", "Federal", "Administracão pública",null,null);
		Estabelecimento estab12 = new Estabelecimento(null, "Hospital de Camaragib", 76444, " Descriçao sobre este hospital12", "Federal", "Administracão pública",null,null);
		Estabelecimento estab13 = new Estabelecimento(null, "UPA pdsw", 600, " Descriçao sobre este hospital13", "Federal", "Administracão pública",3.5,4);
		Estabelecimento estab14 = new Estabelecimento(null, "Pronto Socorro Villa Grande ", 27554, " Descriçao sobre este hospital14", "Federal", "Administracão pública",null,null);
...
//		enderecoRepository.saveAll(Arrays.asList(end1));
		...
		Usuario user3 = new Usuario(null,"Lewis Vangon", "Lews", "test3test@test.com", pe.encode("333333"));
		...
		AvaliacaoEstabelecimento avE2 = new AvaliacaoEstabelecimento(null, sdf.parse("30/10/2021 10:33"),"Hospital Atendimento Ruim",2.0, user1, estab4);
		AvaliacaoEstabelecimento avE3 = new AvaliacaoEstabelecimento(null, sdf.parse("25/10/2021 10:35"),"Hospital teve um atendimento mais ou menos",2.0, user3, estab1);
		AvaliacaoEstabelecimento avE4 = new AvaliacaoEstabelecimento(null, sdf.parse("23/11/2021 11:10"),"Foi bom o atendimento, mas poderia ser melhor",3.0, user4, estab2);
